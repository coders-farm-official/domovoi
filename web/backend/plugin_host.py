...
_WEB_BACKEND_CORE_IMPORTS = (
    ...
    # Lazily imported INSIDE request handlers (audiobooks reindex, music
    # upload's post-write index, podcast poll, satellites tz). Anything
    # imported after the guard is installed must be preloaded here or the
    # request 500s (web F-001) — or, when the call site catches its own
    # failure, quietly does nothing (F-A017).
