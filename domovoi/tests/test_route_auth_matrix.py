...
ALLOWLIST: dict[tuple[str, str, str], str] = {
    ...
    ("web", "DELETE", "/api/music/library/{track_id}"): "daily tier — admin tier in B4 (WEB-5)",
    ...
    ("web", "DELETE", "/api/people/{person_id}"): "daily tier — admin tier in B4 (WEB-5)",
    ("web", "DELETE", "/api/people/{person_id}/profiles/{profile_id}"): "daily tier — admin tier in B4 (WEB-5)",
    ...
    ("web", "POST", "/api/people/{person_id}/favorites"): "daily tier — device tier in wave 2",
    ("web", "DELETE", "/api/people/{person_id}/favorites/{favorite_id}"): "daily tier — device tier in wave 2",
    ("web", "PATCH", "/api/people/{person_id}/preferences"): "daily tier — device tier in wave 2",
    ("web", "DELETE", "/api/denylist/{entry_id}"): "daily tier — admin tier in B4 (WEB-5)",
    ...
    ("web", "POST", "/api/satellites/{room_id}/dropin/start"): "daily tier — device tier in wave 2",
    ("web", "POST", "/api/satellites/{room_id}/dropin/end"): "daily tier — device tier in wave 2",
    ...
    ("web", "POST", "/api/documents/create"): "open today — device tier in B4 (WEB-2)",
    ("web", "POST", "/api/documents/delete"): "open today — admin tier in B4 (WEB-2)",
    ("web", "POST", "/api/documents/download-zip"): "open today — device tier in B4 (WEB-2)",
    ("web", "PUT", "/api/documents/text/{rel_path:path}"): "open today — device tier in B4 (WEB-2)",
    ("web", "PUT", "/api/documents/sheet/{rel_path:path}"): "open today — device tier in B4 (WEB-2)",
    ("web", "POST", "/api/documents/upload"): "open today — device tier in B4 (WEB-2)",
    ("web", "POST", "/api/documents/drawings/read"): "open today — device tier in B4 (WEB-2)",
    ("web", "POST", "/api/documents/drawings/write"): "open today — device tier in B4 (WEB-2)",
    ("web", "POST", "/api/files/upload"): "daily tier (files device blocks) — device tier in wave 2 (REV-1)",
    ("web", "POST", "/api/files/import"): "daily tier (files device blocks) — device tier in wave 2 (REV-1)",
    ("web", "POST", "/api/files/move"): "daily tier (files device blocks) — device tier in wave 2 (REV-1)",
    ...
    ("web", "POST", "/api/videos/position"): "daily tier — device tier in wave 2 (REV-1)",
    ("web", "DELETE", "/api/videos/position"): "daily tier — device tier in wave 2 (REV-1)",
